...
class Product(models.Model):
    ...
    slug = models.SlugField(default="Beat") # After making migrations remove the default="Beat" from your SlugField and replace it with blank="True" Admin Product Table you should be able to see that all of the products registered will have "Beat" as Slug
